...
tipo e negocio
preco
area, quartos, banheiros e vagas, quando conhecidos
condominio e IPTU
CEP, endereco, numero e complemento, quando confirmados
...
- Nao inventar CEP, rua, area, IPTU ou condominio.
- Evitar exibir endereco exato quando o imovel estiver ocupado.
- Conferir coordenadas antes de publicar, se existirem.
...
O primeiro cadastro pode ser publicado com localizacao aproximada quando CEP, rua ou area ainda nao estiverem confirmados.
